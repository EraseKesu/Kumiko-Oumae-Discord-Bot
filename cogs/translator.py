...
dev_list = [
    ('class Erase', 635971624406876170)
]
...
class Translate(commands.Cog):
    ...
    async def translate(self, ctx, lang: str = None, *, text: str = None):
        ...
        try:
            ...
            em.description = f'```bf\n{available}```'
            em.set_footer(text=duration, icon_url=self.bot.user.avatar_url_as(static_format="png"))
            ...
            if lang in conv:
                ...
                e.set_footer(text=duration, icon_url=self.bot.user.avatar_url_as(static_format="png"))
                try:
    ...
    async def langs(self, ctx):
        ...
        em.set_author(name='Available Languages:', icon_url=ctx.message.author.avatar_url),
        em.description = f'```bf\n{available}```'
        em.set_footer(text="Kumiko Oumae Translator", icon_url=self.bot.user.avatar_url_as(static_format="png"))
